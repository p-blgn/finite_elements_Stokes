...
%Affichage des vitesses par des vecteurs
...
% A COMPLETER
affiche_ordre2(-U1+U1_exact, Numtri, Coorneu,sprintf('U1_{exact}-U1 - %s', nom_maillage));
affiche_ordre2(-U2+U2_exact, Numtri, Coorneu,sprintf('U2_{exact}-U2 - %s', nom_maillage));
affiche_ordre1(P_exact-P, NumtriDecale, Coorneu(numsommets,:),sprintf('pression_{exacte}-pression - %s', nom_maillage));
end
